defmodule UrlbotWeb.Live.Flash do
  @moduledoc """
  ...
  defmacro __using__(_opts) do
    quote do
      import UrlbotWeb.Live.Flash, only: [put_live_flash: 3, flash_messages: 1]
  ...
  def flash_messages(assigns) do
    ...
    <div id="liveview-flash">
      <div
        :if={@flash != %{} or Application.get_env(:Urlbot, :environment) == "dev"}
      ...
      >
        ...
        <.flash
          :if={Application.get_env(:Urlbot, :environment) == "dev"}
